...
-- Mod injector: load mods from mods/ folder next to the exe
local _mods_path = love.filesystem.getSourceBaseDirectory() .. '/mods'
package.path = package.path .. ';' .. _mods_path .. '/?.lua'
pcall(require, 'modlist')
require "card"
require "cardarea"
require "blind"
